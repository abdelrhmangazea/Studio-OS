...
export default function Sidebar({ studioName }) {
  ...
  return (
    <aside className="flex w-60 shrink-0 flex-col border-e border-separator bg-surface">
          ...
          >
            <span className="flex items-center justify-between gap-2">
              ...
              {item.to === '/booking-setup' && unseen > 0 && (
                <span className="rounded-full bg-accent px-1.5 py-0.5 text-[11px] font-medium text-on-accent">
                  {unseen}
                </span>
              )}
            </span>
