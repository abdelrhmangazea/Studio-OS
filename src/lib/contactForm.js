...
export function toContactRow(form) {
  ...
  return {
    ...
    id_type: blankToNull(form.id_type),
    id_number: blankToNull(form.id_number),
    id_issuer: blankToNull(form.id_issuer),
...
export function toContactForm(contact) {
  ...
  return {
    ...
    id_type: text(contact.id_type),
    id_number: text(contact.id_number),
    id_issuer: text(contact.id_issuer),
